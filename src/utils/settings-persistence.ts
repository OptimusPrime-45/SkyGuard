...
const SETTINGS_KEY_PREFIXES = [
  ...
  'skyguard-monitors',
  'skyguard-layers',
  'skyguard-disabled-feeds',
  'skyguard-live-channels',
  'skyguard-map-mode',
  'skyguard-variant',
  'skyguard-theme',
  'skyguard-panel-spans',
  'skyguard-panel-order',
  'skyguard-runtime-feature-toggles',
...
export function exportSettings(): void {
  ...
  const exportData: ExportedSettings = {
    ...
    variant: localStorage.getItem('skyguard-variant') || 'full',
    data,
  };
  ...
  a.download = `skyguard-settings-${ts}.json`;
